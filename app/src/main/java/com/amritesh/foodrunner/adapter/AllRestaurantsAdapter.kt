package com.amritesh.foodrunner.adapter
...
import com.amritesh.foodrunner.database.RestaurantEntity
import com.amritesh.foodrunner.fragment.RestaurantFragment
import com.amritesh.foodrunner.model.Restaurants
...
class AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            p0.favImage.clipToOutline = true
        }
        ...
        Picasso.get().load(resObject.imageUrl).error(R.drawable.res_image).into(p0.favImage)
...
//        val resThumbnail = view.findViewById(R.id.) as ImageView
